  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Panel de control con checkboxes estilizados */}
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <label className="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200 cursor-pointer border border-gray-200">
              <input
                type="checkbox"
              ...
              />
              <div className="ml-4">
                <span className="text-sm font-semibold text-gray-700">Pedidos Productivos</span>
                <p className="text-xs text-gray-500 mt-1">Vista de pedidos productivos</p>
              </div>
            </label>
            ...
            <label className="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200 cursor-pointer border border-gray-200">
              <input
                ...
                className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500 focus:ring-2 transition-all duration-200"
              />
              <div className="ml-4">
                <span className="text-sm font-semibold text-gray-700">Pedidos Generales</span>
                <p className="text-xs text-gray-500 mt-1">Vista de pedidos generales del sistema</p>
              </div>
            </label>
          </div>
        </div>
        ...
        <div className="space-y-6">
          {showListaPedidosProductivosVista && (
          ...
          {showListAdmin && (
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                <ListPanolProductosGeneralesVer />
              </div>
            </div>
          )}
        </div>
