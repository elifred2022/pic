...
export default function ListBiComponenteOrdenesCompra() {
              ...
              <CardContent className="pt-0">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-600">{orden.direccion_proveedor}</p>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Teléfono:</span>
                    <p className="text-gray-600">{orden.telefono_proveedor}</p>
                  </div>
                  <div>
