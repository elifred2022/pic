...
export function DashboardModuleCards({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Link
        href={comprasHref}
        className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-blue-600 to-purple-600 p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl"
      >
